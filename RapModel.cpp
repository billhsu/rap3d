...
void RapModel::GetBoundingBox(D3DXVECTOR3& vmax,D3DXVECTOR3& vmin)
{
D3DXMATRIXA16 mat=matScale*matInitRotation*matRotation;
D3DXVec3TransformNormal(&vmax,&vMax,&mat);
D3DXVec3TransformNormal(&vmin,&vMin,&mat);
