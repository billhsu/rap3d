...
void Rap3d::SetFont(const TCHAR*fontname,//Name of font.For example "Times New Roman"
			 DWORD dwHeight,DWORD dwFlags)//The Height of th font
{
m_pFont=new CD3DFont(fontname,dwHeight,dwFlags);
m_pFont->InitDeviceObjects(m_pIDirect3DDevice);
m_pFont->RestoreDeviceObjects();

}

void Rap3d::DrawText(float x,float y,const TCHAR* strText,DWORD dwColor,DWORD dwFlags)
{
